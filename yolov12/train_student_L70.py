...
# ================= KONFIGURASI =================
DATA_YAML = r"C:\Users\mfaiz\Documents\dev\tugas_akhir_final\dataset\scenario_L70_U30\data_student.yaml" # File YAML dataset Student (gabungan labeled + pseudo labeled)
PROJECT_NAME = "hasilAkhir"
RUN_NAME = "scenario_L70_student" 
# ===============================================
