...
# ================= KONFIGURASI =================
DATA_YAML = r"C:\Users\mfaiz\Documents\dev\tugas_akhir_final\dataset\scenario_L90_U10\data_student.yaml" # File YAML dataset Student (gabungan labeled + pseudo labeled)
PROJECT_NAME = "hasilAkhir"
RUN_NAME = "scenario_L90_student" 
# ===============================================
